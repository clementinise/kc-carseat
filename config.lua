...
Config.LeaveEngineStaysRunning      = true      -- Should the engine stay running when a player exits a vehicle, regardless of whether they long/double press or not?

-- Locale
Config.Language						= 'en'		-- Currently Available: fr, en

-- Misc
Config.Debug                        = true      -- If you suspect that something isn't working correctly, set 'Config.Debug' to true. This will print debug logs in your console
